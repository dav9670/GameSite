...
class RelationshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post relationships_url, params: { relationship: { friend_id: @relationship.friend_id, status: @relationship.status, user_id: @relationship.user_id } }
    end
  ...
  test "should update relationship" do
    patch relationship_url(@relationship), params: { relationship: { friend_id: @relationship.friend_id, status: @relationship.status, user_id: @relationship.user_id } }
